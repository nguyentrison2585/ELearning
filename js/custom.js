$(document).ready(function() {
  ...
  $("#yui_3_17_2_2_1587201326959_225").click(function() {
    $($(this).find(".dropdown-menu")[0]).toggleClass("show");
  });

  $("#ecourses-dropdown").click(function() {
    $($(this).find(".dropdown-menu")[0]).toggleClass("show");
  });
  ...
  function showSlides(n) {
    ...
    for (i = 0; i < dots.length; i++) {
      $(dots[i]).removeClass("is-selected");
    }
    slides[slideIndex-1].style.display = "block";
    $(dots[slideIndex-1]).addClass("is-selected");
  }
        ...
        var subject_block = `<div class="span3" id="yui_3_17_2_2_1587460599521_208">
          <div class="fp-coursebox" id="yui_3_17_2_2_1587460599521_209">
            <div class="fp-coursethumb" id="yui_3_17_2_2_1587460599521_212">
              <a href="https://lms.hust.edu.vn/course/view.php?id=256" id="yui_3_17_2_2_1587460599521_211">
            ...
            <div class="fp-courseinfo" id="yui_3_17_2_2_1587460599521_249">
              ...
              <div class="readmore" id="yui_3_17_2_2_1587460599521_250"><a href="https://lms.hust.edu.vn/course/view.php?id=256">Readmore<i class="fa fa-angle-double-right"></i></a></div>
            </div>
          </div>
        </div>`
